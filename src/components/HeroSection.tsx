...
const HeroSection: React.FC = () => {
  ...
  return (
    <section
      className="relative bg-invoga-blue text-white py-36 px-4"
    >
      {/* Remove overlay as background is now a solid color */}
